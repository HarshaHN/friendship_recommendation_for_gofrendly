...
#%%------------------------------
""" 02. PinSAGE train """
# positive and negative links ([0,0,1,2,3], [1,2,3,4,4]), ([0,0,1,2,2], [3,4,4,1,3])
pos = torch.tensor([[0,0,1,2,3], [1,2,3,4,4]], requires_grad=False)
neg = torch.tensor([[0,0], [3,4]], requires_grad=False)
...
def lossfunc(newemb):
    ...
    margin = 1.0
    return F.relu(n - p + margin)#.clamp(min=0)
