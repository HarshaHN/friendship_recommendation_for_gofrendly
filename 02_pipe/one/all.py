...
#df = pd.read_hdf("../data/common/train/all_location.h5", key='info')
d = df.country.value_counts()[:6]
sns.set(rc={'figure.figsize':(12,6)})
g = sns.barplot(d.index, d.values)
g.set(xlabel='Country', ylabel='User size', title="Users Vs. Country")


for index, value in enumerate(d.values):
    #print(value, index, str(value))
    g.text(index-0.2, value+600, str(value))

g.get_figure().savefig("../results/visuals/output.png")
...
df2 = pd.read_hdf("../data/common/train/all_location.h5", key='info')
...
valmf = pd.read_hdf("../data/common/val/all_network.h5", key='mf')
